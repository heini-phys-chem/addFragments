...
def exchangeAtom(C,H,molTS,molFG,outfile, bondLength):
  ...
  convTS.WriteFile(TS, "quadrupel/" + outfile)
...
if __name__ == "__main__":
  ...
  if (pos1 != "A" and pos2 != "A" and pos3 != "A"):
    C = [2]
    H = [5]
    pos = [4]
  if (pos1 != "A" and pos2 != "A" and pos4 != "A"):
    C = [2]
    H = [5]
    pos = [3]
  if (pos1 != "A" and pos3 != "A" and pos4 != "A"):
    C = [1]
    H = [5]
    pos = [2]
  if (pos2 != "A" and pos3 != "A" and pos4 != "A"):
    C = [1]
    H = [5]
    pos = [1]
